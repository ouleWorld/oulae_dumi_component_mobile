 ...
 */
export default function NonameGesture(element, options) {
...
NonameGesture.prototype.handleRotate = function (e, a, b) {
  e._rotate =
    this.getAngle(a, b) - this.getAngle(this.lastPoint1, this.lastPoint2);
...
NonameGesture.prototype.handlePinch = function (e, a, b) {
  e._scale =
    this.getDistance(a, b) / this.getDistance(this.lastPoint1, this.lastPoint2);
 ...
 * @returns
 */
NonameGesture.prototype.getImgSize = function (
  naturalWidth,
  naturalHeight,
  maxWidth,
  maxHeight,
